...
echo "<!-- SEED TIME  $secX:   $year-$mon-$mday $hour:$min:$sec  LOCAL GMT VERSETZTE JETZT: $LOCAL_GMT_OFF  DST: $isdst -->\n";
...
<table align=center width="700" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
  ...
  <tr>
	...
	<td align=left width="75%"><font face="arial, helvetica" size=1><input type=text value="<?php echo $list_id_override ?>" name='list_id_override' size=10 maxlength=8> (nur Zahlen or leave blank for values in the file)</td>
  </tr>
  <tr>
	<td align=right width="25%"><font face="arial, helvetica" size=2>Telefon-Nr Override: </font></td>
	<td align=left width="75%"><font face="arial, helvetica" size=1><input type=text value="<?php echo $phone_code_override ?>" name='phone_code_override' size=8 maxlength=6> (nur Zahlen or leave blank for values in the file)</td>
  </tr>
  <tr>
	<td align=right><B><font face="arial, helvetica" size=2>Zu verwenden Dateiaufbau:</font></B></td>
	<td align=left><font face="arial, helvetica" size=2><input type=radio name="file_layout" value="standard" checked>Standard Format&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name="file_layout" value="custom">Kundenspezifischer Plan</td>
  </tr>
    <tr>
	...
	<option value="DUPTITLEALTPHONELIST">CHECK FOR DUPLICATES BY TITLE/ALT-PHONE IN LISTE IDENTIFIKATION</option>
...
if ( (!$AC_processed) and ($dst_range == 'SSM-FSN') )
	...
	#     Based on Second Sonntag March to First Sonntag November at 2 am.
	#     INPUTS:
	#       mm              INTEGER       Month.
	#       dd              INTEGER       Day of the month.
	#       ns              INTEGER       Seconds into the day.
	#       dow             INTEGER       Day of week (0=Sonntag, to 6=Samstag)
	#     OPTIONAL INPUT:
...
if ( (!$AC_processed) and ($dst_range == 'FSA-LSO') )
	...
	#     This is returns 1 if Daylight Savings Time is in effect and 0 if 
	#       Standard time is in effect.
	#     Based on first Sonntag in April and last Sonntag in October at 2 am.
	#**********************************************************************
...
if ( (!$AC_processed) and ($dst_range == 'LSM-LSO') )
	...
	#       Standard time is in effect.
	#     Based on last Sonntag in March and last Sonntag in October at 1 am.
	#**********************************************************************
...
if ( (!$AC_processed) and ($dst_range == 'LSO-LSM') )
	...
	#     This is s 1 if Daylight Savings Time is in effect and 0 if 
	#       Standard time is in effect.
	#     Based on last Sonntag in October and last Sonntag in March at 1 am.
	#**********************************************************************
...
if ( (!$AC_processed) and ($dst_range == 'FSO-LSM') )
	...
	#     This is s 1 if Daylight Savings Time is in effect and 0 if 
	#       Standard time is in effect.
	#     Based on first Sonntag in October and last Sonntag in March at 1 am.
	#**********************************************************************
...
if ( (!$AC_processed) and ($dst_range == 'FSO-FSA') )
	{
	if ($DBX) {print "     Sonntag in October to First Sonntag in April\n";}
	#**********************************************************************
	# FSO-FSA
	#   2008+ AUSTRALIA ONLY (country code 61)
	#     This is returns 1 if Daylight Savings Time is in effect and 0 if 
	#       Standard time is in effect.
	#     Based on first Sonntag in October and first Sonntag in April at 1 am.
	#**********************************************************************
...
if ( (!$AC_processed) and ($dst_range == 'FSO-TSM') )
	...
	#     This is s 1 if Daylight Savings Time is in effect and 0 if 
	#       Standard time is in effect.
	#     Based on first Sonntag in October and third Sonntag in March at 1 am.
	#**********************************************************************
...
if ( (!$AC_processed) and ($dst_range == 'LSS-FSA') )
	{
	if ($DBX) {print "     Last Sonntag in September to First Sonntag in April\n";}
	#**********************************************************************
	# LSS-FSA
	#   2007+ NEW ZEALAND (country code 64)
	#     This is returns 1 if Daylight Savings Time is in effect and 0 if 
	#       Standard time is in effect.
	#     Based on last Sonntag in September and first Sonntag in April at 1 am.
	#**********************************************************************
...
if ( (!$AC_processed) and ($dst_range == 'TSO-LSF') )
	...
	#     Based on Third Sonntag October to Last Sonntag February at 1 am.
	#**********************************************************************
