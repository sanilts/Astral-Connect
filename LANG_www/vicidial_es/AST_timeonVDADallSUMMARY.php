...
echo "<TITLE>Tiempo Real All Campañas Summary</TITLE></HEAD><BODY BGCOLOR=WHITE marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";
...
echo "<b>Tiempo Real All Campañas Summary</b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; \n";
...
echo " &nbsp; &nbsp; &nbsp; <a href=\"./admin.php?ADD=999999\">INFORMES</a>";
echo "<BR><BR>\n\n";
...
if ($adastats>1)
	...
	echo "<TD ALIGN=RIGHT><font size=2>&nbsp; <B>MAX NIVEL:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $maxDIALlev &nbsp; </TD>";
...
echo "<TD ALIGN=RIGHT><font size=2><B>DIAL MÉTODO:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $DIALmethod &nbsp; &nbsp; </TD>";
echo "</TR>";

echo "<TR>";
echo "<TD ALIGN=RIGHT><font size=2><B>HOPPER NIVEL:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $HOPlev &nbsp; &nbsp; </TD>";
