...
echo "<!-- SEED TIME  $secX:   $year-$mon-$mday $hour:$min:$sec  LOCAL GMT OFFSET: $LOCAL_GMT_OFF  DST: $isdst -->\n";
...
function ShowProgress(good, bad, total, dup, post) {
	...
	parent.lead_count.document.write('<html><body><table border=0 width=200 cellpadding=10 cellspacing=0 align=center valign=top><tr bgcolor="#000000"><th colspan=2><font face="arial, helvetica" size=3 color=white>Κατάσταση αρχείου:</font></th></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Good:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+good+'</B></font></td></tr><tr bgcolor="#990000"><td align=right><font face="arial, helvetica" size=2 color=white><B>Bad:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+bad+'</B></font></td></tr><tr bgcolor="#000099"><td align=right><font face="arial, helvetica" size=2 color=white><B>Total:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+total+'</B></font></td></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B> &nbsp; </B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B> &nbsp; </B></font></td></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Duplicate:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+dup+'</B></font></td></tr><tr bgcolor="#009900"><td align=right><font face="arial, helvetica" size=2 color=white><B>Postal Match:</B></font></td><td align=left><font face="arial, helvetica" size=2 color=white><B>'+post+'</B></font></td></tr></table><body></html>');
...
<table align=center width="700" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
  <tr>
	<td align=right width="35%"><B><font face="arial, helvetica" size=2>Εισαγωγή οδηγών από αυτό το αρχείο:</font></B></td>
	<td align=left width="65%"><input type=file name="leadfile" value="<?php echo $leadfile ?>"> <?php echo "$NWB#vicidial_list_loader$NWE"; ?></td>
  </tr>
  <tr>
	<td align=right width="25%"><font face="arial, helvetica" size=2>ID Λίστας Override: </font></td>
	<td align=left width="75%"><font face="arial, helvetica" size=1><input type=text value="<?php echo $list_id_override ?>" name='list_id_override' size=10 maxlength=8> (μόνο αριθμοί or leave blank for values in the file)</td>
  </tr>
  <tr>
	<td align=right width="25%"><font face="arial, helvetica" size=2>Μήκη Override: </font></td>
	<td align=left width="75%"><font face="arial, helvetica" size=1><input type=text value="<?php echo $phone_code_override ?>" name='phone_code_override' size=8 maxlength=6> (μόνο αριθμοί or leave blank for values in the file)</td>
  </tr>
  <tr>
	<td align=right><B><font face="arial, helvetica" size=2>Μορφή αρχείων για χρήση:</font></B></td>
	<td align=left><font face="arial, helvetica" size=2><input type=radio name="file_layout" value="standard" checked>Standard Format&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name="file_layout" value="custom">Εμφάνιση συνήθειας</td>
  </tr>
    <tr>
	<td align=right width="25%"><font face="arial, helvetica" size=2>Διπλός έλεγχος μολύβδου: </font></td>
	...
	<option value="DUPLIST">CHECK FOR DUPLICATES BY PHONE IN ID ΛΙΣΤΑΣ</option>
	<option value="DUPCAMP">ΕΛΕΓΧΟΣ ΓΙΑ ΤΑ ΑΝΤΙΓΡΑΦΑ ΤΗΛΕΦΩΝΙΚΩΣ ΣΕ ΟΛΟΥΣ ΤΟΥΣ ΚΑΤΑΛΟΓΟΥΣΕΚΣΤΡΑΤΕΙΑΣ</option>
	<option value="DUPSYS">ΕΛΕΓΧΟΣ ΓΙΑ ΤΑ ΑΝΤΙΓΡΑΦΑ ΤΗΛΕΦΩΝΙΚΩΣ ΤΟ ΣΕ ΟΛΟΚΛΗΡΟ ΣΥΣΤΗΜΑ</option>
	<option value="DUPTITLEALTPHONELIST">CHECK FOR DUPLICATES BY TITLE/ALT-PHONE IN ID ΛΙΣΤΑΣ</option>
	<option value="DUPTITLEALTPHONESYS">CHECK FOR DUPLICATES BY TITLE/ALT-PHONE IN ENTIRE SYSTEM</option>
	</select></td>
  </tr>
  <tr>
	<td align=right width="25%"><font face="arial, helvetica" size=2>Συμβούλευση ζώνης χρονικής ανοχής: </font></td>
...
<tr>
  ...
  <tr><td align=left><font size=1> &nbsp; &nbsp; &nbsp; &nbsp; <a href="admin.php?ADD=100" target="_parent">ΠΙΣΩ ΣΤΗ ΔΙΑΧΕΙΡΙΣΗ</a></font></td><td align=right><font size=1>LIST LOADER- &nbsp; &nbsp; ΕΚΔΟΣΗ: <?php echo $version ?> &nbsp; &nbsp; ΔΗΜΙΟΥΡΓΙΑ: <?php echo $build ?> &nbsp; &nbsp; </td></tr>
</table>
<?php } ?>
	...
	if ($OK_to_process) {
		...
		if (!eregi(".csv", $leadfile_name) && !eregi(".xls", $leadfile_name)) {
			...
			if (strlen($phone_code_override)>0) 
				{
				print "<BR><BR>ΣΥΜΠΛΗΡΩΜΑΤΙΚΗ ΠΡΟΜΉΘΕΙΑ ΤΗΛΕΦΩΝΙΚΟΥ ΚΩΔΙΚΑ ΓΙΑ ΑΥΤΟ ΤΟ ΑΡΧΕΙΟ: $phone_code_override<BR><BR>";
				}
...
if ($leadfile) {
	...
	#	echo "|$WeBServeRRooT/vicidial/listloader.pl --forcelistid=$list_id_override --lead-file=$lead_file|";
		...
		print "<script language='JavaScript1.2'>document.forms[0].leadfile.disabled=false; document.forms[0].submit_file.disabled=false; document.forms[0].reload_page.disabled=false;</script>";
			...
			print "    <th align=right><font class='standard' color='white'>VICIDIAL Στήλη</font></th>\r\n";
			print "    <th><font class='standard' color='white'>Αρχεία δεδομένων</font></th>\r\n";
			print "  </tr>\r\n";
