...
echo "<TITLE>Real-Time All Campagne Summary</TITLE></HEAD><BODY BGCOLOR=WHITE marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";
...
echo "<b>Real-Time All Campagne Summary</b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; \n";
